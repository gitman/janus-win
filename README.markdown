...
1. `git clone git://github.com/gitman/janus-win.git "%USERPROFILE%\vimfiles"`
2. `cd "%USERPROFILE%\vimfiles"`
3. `rake`

or

  `curl https://raw.github.com/gitman/janus-win/master/bootstrap.cmd -k -o bootstrap.cmd & bootstrap.cmd`
